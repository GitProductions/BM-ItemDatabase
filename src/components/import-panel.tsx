              ...
              export const ImportPanel: React.FC<ImportPanelProps> = ({
                ...
                <div className="">
                  <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 shadow-lg">
                    ...
                    <div className="bg-slate-950/50 rounded-lg p-2 mb-4 border border-slate-800 text-sm text-slate-400">
                    ...
                    <div className="grid gap-6 lg:grid-cols-[1.1fr,0.95fr]">
                      <div className="space-y-4">
                        <div className="space-y-1">
                          <label htmlFor="import-username" className="text-sm font-semibold text-slate-200">
                            User Name
                          </label>
                          <input
                            id="import-username"
                            ...
                            className="w-full rounded-lg border border-slate-700 bg-slate-950/60 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                          />
                          <p className="text-[11px] text-slate-500">Assigning a name helps you locate this batch later.</p>
                        </div>
                        ...
                        <textarea
                          ...
                          className="w-full h-64 bg-slate-950 border border-slate-700 rounded-lg p-4 font-mono text-xs text-slate-300 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                        />
