...
const slotKeywords: Record<SlotKey, string[]> = {
  head: ['helm', 'hood', 'cap', 'hat', 'crown', 'helmet'],
  neck1: ['amulet', 'choker', 'necklace', 'pendant'],
  neck2: ['amulet', 'choker', 'necklace', 'pendant'],
  ...
  finger1: ['ring', 'band'],
  finger2: ['ring', 'band'],
  wrist1: ['bracelet', 'bracer', 'bangle', "bracers"],
  wrist2: ['bracelet', 'bracer', 'bangle' , "bracers"],
